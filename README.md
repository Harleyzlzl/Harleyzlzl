...
---
### About Me | 关于我
我是 **24岁** 的AI与数据科学从业人员，专注 **Python + AI + 大数据分析 + AIGC** 方向。
热爱把模型真正落地：从 RAG 问答、seedream电商全链路生图，到 **正在开发的 AI 量化交易软件**，我都追求“可部署、可量化、可盈利”的效果。

- 🎯 当前目标：AI 驱动的量化交易系统 + RAG 赋能电商全链路自动化
- 🌍 时区：UTC+8
- 📧 邮箱：26251780853@qq.com
- 📱 电话：13178383023
...
| 领域                  | 熟练度     | 代表关键词 / 工具                                      |
|-----------------------|------------|-------------------------------------------------------|
| 🐍 Python 编程        | ★★★★★     | 数据分析、爬虫、FastAPI、自动化脚本                   |
| 📊 大数据分析         | ★★★★★     | Hadoop、Spark、Hive、Kafka、HBase、MySQL              |
| 🤖 机器学习 / 深度学习| ★★★★★     | PyTorch、TensorFlow、Keras、CNN、LSTM、GNN、SVM、RF   |
| 🧠 LLM & RAG          | ★★★★☆     | Hugging Face、LangChain、BERT、BART、Elasticsearch    |
| 🎨 AIGC / 图像生成    | ★★★★☆     | ComfyUI、文本到图像/视频、电商模特图自动化            |
| 📈 量化交易           | ★★★★☆     | **AI 量化交易软件**（正在开发）——信号生成、回测、风险控制 |
| ☁️ 部署 & 工程化      | ★★★★☆     | Docker、Flask、AWS、CUDA / ROCm、多环境部署脚本       |

---

### What I Build | 我主要做什么（重点更新）
| 项目类型                  | 项目名称 / 时间                          | 核心技术 & 成果                                                                 |
|---------------------------|------------------------------------------|---------------------------------------------------------------------------------|
...
<div align="center">
  <a href="mailto:26251780853@qq.com">
    <img src="https://img.shields.io/badge/Email%20%7C%20邮箱-26251780853@qq.com-blue?style=for-the-badge&logo=gmail&logoColor=white" alt="Email">
  </a>
  <a href="tel:+8613178383023">
    <img src="https://img.shields.io/badge/Phone%20%7C%20电话-13178383023-green?style=for-the-badge&logo=phone&logoColor=white" alt="Phone">
  </a>
  <a href="https://github.com/Harleyzlzl/Harleyzlzl/blob/main/简历.pdf" target="_blank">
    <img src="https://img.shields.io/badge/Resume%20%7C%20简历-PDF-red?style=for-the-badge&logo=adobeacrobat&logoColor=white" alt="Resume">
  </a>
  <a href="https://linkedin.com/in/你的领英" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn%20%7C%20领英-blue?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn">
  </a>
</div>

---

> **从数据中发现机会，用 AI 创造价值** —— 数据科学 × AIGC × 量化交易全栈实践者

<div align="center">
  <img src="https://visitor-badge.laobi.icu/badge?page_id=Harleyzlzl.Harleyzlzl" alt="访客数"/>
</div>
